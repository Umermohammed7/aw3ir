    ...
    app = new Vue({
        ...
        methods: {
            ...
            meteo: function (_city) {  
                ...
                fetch('https://api.openweathermap.org/data/2.5/weather?q='+_city.name+'&units=metric&lang=fr&apikey=43255fae2e276f8ddb8a7e42f4c97536')
                    .then(function(response) {                                                               //apikey appid
